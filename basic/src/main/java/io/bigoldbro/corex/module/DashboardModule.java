...
public interface DashboardModule {
    ...
    void kick(@Param("1") List<String> userIds, @Param("2") int code, @Param("3") String msg);

    @Api(value = "push", type = AUTH_TYPE_ADMIN)
    void push(@Param("1") List<String> channels, @Param("2") List<String> userIds, @Param("3") String topic, @Param("4") String msg);
}
